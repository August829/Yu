...
# Analysis
In the app/modules/ut-frame/admin/update.php

The download address of the code online update function is spliced like this:

<img width="1173" height="910" alt="image" src="https://github.com/user-attachments/assets/10a5ae18-441b-4d98-855c-1db1286a40d7" />

$url=$config["UPDATEURL"]."/".$i.".zip";
We change $config["UPDATEURL"] to the attacker's remote url, and then upload webshell.zip, $i can be written as controllable

And the downloaded file will be automatically decompressed and the path is /update/

users can remotely downloading the compressed package and automatically decompressing it and RCE. We can upload a zip compressed package on the remote server, which contains a webshell file.
<img width="521" height="141" alt="image" src="https://github.com/user-attachments/assets/6087aa72-a311-4154-aecd-1480bcae1f4e" />
webshell.php->webshell.zip
