...
The root cause of the vulnerability is that the Event Action system fully trusts administrator input and does not perform any verification of the URL when performing HTTP request operations. 
